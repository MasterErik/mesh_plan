...
@RestController
@RequestMapping("/api/mesh-plan-kafka")
public class MeshPlanKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MeshPlanKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MeshPlanKafkaResource(KafkaProperties kafkaProperties) {
